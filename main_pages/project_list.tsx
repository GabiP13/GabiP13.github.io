                            ...
                            <div className='pb-5'>
                                ...
                                <div className="grid grid-cols-[max-content_2fr] m-6">
                                    <div className="dot col-span-1">
                                        <img className='pl-1 pt-1 h-[40px]' src='../images/bubbysleep.png'/>
                                    </div>
                                ...
                                <div className="grid grid-cols-[max-content_2fr] m-6">
                                    <div className="dot col-span-1">
                                        <img className='pl-1 pt-1 h-[40px]' src='../images/cherry_blossoms.jpg'/>
                                    </div>
                                    <div className="m-3 pl-4">
                                        <h2>Izzy Saccone</h2>
                                    </div>
                                ...
                                <div className="grid grid-cols-[max-content_2fr] m-6">
                                    <div className="dot col-span-1">
                                        <img className='pl-1 pt-1 h-[40px]' src='graduationphoto.jpeg'/>
                                    </div>
                                    <div className="m-3 pl-4">
                                ...
                                <div className='pl-11'>
                                    <h2>
                                        <div className='pb-3'>
                                            ...
                                            <label className='pl-4'>Intro to Machine Learning</label><br />
                                        </div>
                                        <div className='pb-3'>
                                            <input type="checkbox" id="class2" name="class2" value="info200" />
                                            <label className='pl-4'>Intellectual Foundations of Informatics</label><br />
                                        </div>
                                        <div className='pb-3'>
                                            <input type="checkbox" id="class3" name="class3" value="psych101" />
                                            <label className='pl-4'>Psychology 101</label><br />
                                        </div>
                                    </h2>
                                </div>
